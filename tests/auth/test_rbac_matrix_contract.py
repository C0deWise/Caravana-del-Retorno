...
RBAC_EXPECTATIONS: dict[tuple[str, str], set[int]] = {
    ...
    ("PATCH", "/api/v1/usuario/solicitud-parentesco/rechazar/{solicitud_id}"): {1, 2},
    ("PATCH", "/api/v1/usuario/solicitud-parentesco/aceptar/{solicitud_id}"): {1, 2},
    ...
    ("GET", "/api/v1/retornos/ultimo-retorno"): {1, 2, 3},
    ...
    ("DELETE", "/api/v1/grupoRetorno/eliminar-grupo/{gr_codigo}"): {1, 2},
    # Personas
